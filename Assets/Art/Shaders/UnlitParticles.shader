Shader "Unlit/Unlit Particles"
{
    // TODO: Look at frame debugger to find out what is happening when flame particles are set to render que transparent! why does that work? 
    Properties
    {
    ...
    Category
    {
        SubShader
        {
            Tags { "RenderType"="Transparent" "IgnoreProjector"="True" "PreviewType"="Plane" "PerformanceChecks"="False" "Queue"= "Transparent+100"}
